...
* Mivel $\lim a_n = A$, ezért $\forall \varepsilon > 0$-hoz $\exists n_1 \in \mathbb{N}$, hogy $\forall n \ge n_1$ esetén $a_n \in K_\varepsilon(A)$, azaz $A - \varepsilon < a_n < A + \varepsilon$.
* Mivel $\lim c_n = A$, ezért $\forall \varepsilon > 0$-hoz $\exists n_2 \in \mathbb{N}$, hogy $\forall n \ge n_2$ esetén $c_n \in K_\varepsilon(A)$, azaz $A - \varepsilon < c_n < A + \varepsilon$.
...
**2. eset: $A = \infty$**
* Mivel $\lim a_n = \infty$, ezért a definíció szerint $\forall P \in \mathbb{R}$ (tetszőlegesen nagy) számhoz $\exists n_1 \in \mathbb{N}$, hogy $\forall n \ge n_1$ esetén $a_n > P$.
* Legyen $n_0 = \max\{n_1, N\}$. Ekkor $\forall n \ge n_0$ esetén a tétel feltételét is belevéve felírható:
$$b_n \ge a_n > P$$
* Mivel $\forall P \in \mathbb{R}$-hez találtunk olyan $n_0$ küszöbindexet, hogy $n \ge n_0$ esetén $b_n > P$, ezért $\lim b_n = \infty$.

**3. eset: $A = -\infty$**
* Mivel $\lim c_n = -\infty$, ezért a definíció szerint $\forall P \in \mathbb{R}$ (tetszőlegesen kicsi) számhoz $\exists n_1 \in \mathbb{N}$, hogy $\forall n \ge n_1$ esetén $c_n < P$.
* Legyen $n_0 = \max\{n_1, N\}$. Ekkor $\forall n \ge n_0$ esetén a tétel feltételét is belevéve felírható:
$$b_n \le c_n < P$$
* Mivel $\forall P \in \mathbb{R}$-hez találtunk olyan $n_0$ küszöbindexet, hogy $n \ge n_0$ esetén $b_n < P$, ezért $\lim b_n = -\infty$.
...
* $\forall \varepsilon > 0$-hoz $\exists n_1$, hogy $\forall n \ge n_1$ esetén: $|a_n| < \frac{\varepsilon}{2}$
* $\forall \varepsilon > 0$-hoz $\exists n_2$, hogy $\forall n \ge n_2$ esetén: $|b_n| < \frac{\varepsilon}{2}$
...
* Innentől kezdve pontosan alkalmazható a fenti **ii, pont**, ahol a korlátos sorozat szerepét most a $(b_n)$ tölti be. Így az $(a_n b_n)$ szorzat is nullsorozat. $\square$